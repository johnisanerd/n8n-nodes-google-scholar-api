...
import { properties } from './ApifyGoogleScholar.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'm22qEjpnfxa4H1ijE' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-scholar-api' as string;
export const CLASS_NAME = 'ApifyGoogleScholar' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-scholar-app' as string;

export const DISPLAY_NAME = 'Google Scholar' as string;
export const DESCRIPTION =
	'Search Google Scholar and return academic papers with titles, publication info, and links' as string;

export class ApifyGoogleScholar implements INodeType {
